---
  title: 'Ödev 2'
author: "Aykhan EYvazov 21080055"
---
...
```{r}
Wizards[3,4,5] <- "Hermione" , "Ginny" , "Malfoy"
...
```{r}
s <- c(18, 95, 76, 90, 84, 83, 80, 79, 63, 76, 55, 78, 90, 81, 42, 88, 89, 92, 73, 83, 72, 85, 66, 77, 82, 99, 87)
mean(s) 
median(s)
range(s)
```
...
"incomes" <- c(22000,67000,70000,72000)
"expenses" <- c(3000,23000,32000,35000 )
income- expenses 
savings <- c( 19000, 44000, 38000, 3700)
